...
const defaultConfig = {
  ...
  display: { showTokenBar: true, showDiffStats: true, showToolActivity: true, showCost: true, showDuration: true, showCurrentDir: true, showVersion: true, showPermissionMode: true, useNerdFonts: false, unicode: false, maxLines: 3, progressBarWidth: 10, showCacheHitRate: true },
